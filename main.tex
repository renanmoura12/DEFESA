...
\vspace{4cm}
{\textbf{DESENVOLVIMENTO DE UM MODELO DE APRENDIZADO DE MÁQUINA PARA PREDIÇÃO DE PRÉ-ECLÂMPSIA SEM USO DE BIOMARCADORES: UMA ABORDAGEM BASEADA EM DADOS CLÍNICOS E LAUDOS ULTRASSONOGRÁFICOS DE ROTINA}}
...
A metodologia do desenvolvimento do modelo PPML seguiu o processo de pipeline de aprendizado de máquina, baseado no modelo proposto por \cite{Kreuzberger2023MLOps}, adaptado à nossa proposta de aplicação clínica.
\begin{figure}[H]
    \centering
